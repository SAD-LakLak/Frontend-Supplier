                ...
                <div className="flex-1 w-[50%] flex flex-col justify-between items-center bg-primaryMiddle h-full px-4">
                    ...
                    <div className={"flex flex-col items-center w-full mb-4"}>
                        <Button
                            ...
                            className="font-IRANSansXDemiBold rounded-3xl w-fit px-6 py-2 bg-primary text-white mb-8"
                        >
                            ثبت‌ نام
                        </Button>
                        <p className="font-IRANSansXDemiBold w-full text-center mt-2 mb-8" dir="rtl">
                            حساب کاربری دارید؟
